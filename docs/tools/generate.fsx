...
let website = "/FSharp.QueryProvider"

let githubLink = "http://github.com/VoiceOfWisdom/FSharp.QueryProvider"

// Specify more information about your project
let info =
  [ "project-name", "FSharp.QueryProvider"
    "project-author", "Xavier Zwirtz"
    "project-summary", "Makes implementing IQueryable and IQueryProvider in F# functional and easy."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharp.QueryProvider" ]
